    ...
    final notifications = [
      {
        'id': 1,
        'type': 'status_update',
        'title': 'دۆخی هاوردە نوێکرایەوە',
        'message': 'هاوردەی #abc123 گەیەندرا',
      ...
      },
      {
        ...
        'message': 'کڕیار کێشەیەکی بۆ هاوردەی #def456 ڕاپۆرت کردووە',
      ...
      },
      {
        'id': 3,
        'type': 'assignment',
        'title': 'هاوردەیەکی نوێ ئێسپێردرا',
        'message': 'هاوردەی #ghi789 بۆ شۆفێر John ئێسپێردرا',
      ...
      },
      {
        'id': 4,
        'type': 'status_update',
        'title': 'هاوردە لە ڕێگایە',
        'message': 'هاوردەی #jkl012 ئێستا لە ڕێگایە',
        'time': l10n.yesterday,
        'read': true,
      },
      {
        ...
        'message': 'ڕاپۆرتی هاوردەی #mno345 چارەسەرکرا',
        'time': l10n.yesterday,
        'read': true,
      },
    ];
